...
public abstract class Im920Packet {
	...
	public String toString() {
		String hdr = String.format("NodeId:0x%02X, ModuleId: 0x%04X, RSSI:%d, Payload size: %d, Flag(frag/ack): %b/%b, Seq: 0x%02X, Packet type: %s\nBytes: ", nodeId, moduleId, rssi, getPayloadLength(), isFragmented(), isAckRequested(), getSeqNum(), type);
